...
assert stirling(2, 1) == 1
assert stirling(2, 2) == 1
assert stirling(2, 3) == 0

assert stirling(3, 1) == 1
assert stirling(3, 2) == 3
assert stirling(3, 3) == 1

assert stirling(4, 1) == 1
assert stirling(4, 2) == 7
assert stirling(4, 3) == 6
assert stirling(4, 4) == 1

assert stirling(5, 1) == 1
assert stirling(5, 2) == 15
assert stirling(5, 3) == 25
assert stirling(5, 4) == 10
assert stirling(5, 5) == 1

assert stirling(20, 15) == 452329200
